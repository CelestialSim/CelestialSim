...
/// </summary>
public class CesDivConstraintShader
{
    private readonly RenderingDevice rd;
    private readonly string shaderPath = "res://addons/celestial_sim/client/division/CesDivConstraintShader.slang";

    public CesDivConstraintShader(RenderingDevice rd)
    {
        this.rd = rd;
    }
